...
cache_t cache[] = {
    ...
    { 0, TAG_EMS_POWER_PV, 0, "e3dc/solar/power", "%i", "", RSCP::eTypeInt32, 1, 0, 2 },
    { 0, TAG_EMS_POWER_BAT, 0, "e3dc/battery/power", "%i", "", RSCP::eTypeInt32, 1, 0, 2 },
    { 0, TAG_EMS_POWER_HOME, 0, "e3dc/home/power", "%i", "", RSCP::eTypeInt32, 1, 0, 2 },
    { 0, TAG_EMS_POWER_GRID, 0, "e3dc/grid/power", "%i", "", RSCP::eTypeInt32, 1, 0, 2 },
    { 0, TAG_EMS_POWER_ADD, 0, "e3dc/addon/power", "%i", "", RSCP::eTypeInt32, 1, 0, 2 },
    ...
    { TAG_BAT_DATA, TAG_BAT_RSOC, 0, "e3dc/battery/rsoc", "%0.1f", "", RSCP::eTypeFloat32, 1, 0, 2 },
    ...
    { TAG_PVI_DC_POWER, TAG_PVI_VALUE, 0, "e3dc/pvi/power/string_1", "%.0f", "", RSCP::eTypeFloat32, 1, 0, 2 },
    { TAG_PVI_DC_POWER, TAG_PVI_VALUE, 1, "e3dc/pvi/power/string_2", "%.0f", "", RSCP::eTypeFloat32, 1, 0, 2 },
    { TAG_PVI_DC_VOLTAGE, TAG_PVI_VALUE, 0, "e3dc/pvi/voltage/string_1", "%.0f", "", RSCP::eTypeFloat32, 1, 0, 2 },
    { TAG_PVI_DC_VOLTAGE, TAG_PVI_VALUE, 1, "e3dc/pvi/voltage/string_2", "%.0f", "", RSCP::eTypeFloat32, 1, 0, 2 },
    { TAG_PVI_DC_CURRENT, TAG_PVI_VALUE, 0, "e3dc/pvi/current/string_1", "%0.2f", "", RSCP::eTypeFloat32, 1, 0, 2 },
    { TAG_PVI_DC_CURRENT, TAG_PVI_VALUE, 1, "e3dc/pvi/current/string_2", "%0.2f", "", RSCP::eTypeFloat32, 1, 0, 2 },
